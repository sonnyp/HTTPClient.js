(function (global) {
  ...
  var joinPaths = function (paths) {
    ...
    for (var i = 0; i < paths.length; i++) {
      ...
      if (typeof path !== 'string') {
        throw new TypeError('argument to joinPaths must be an array with strings')
      }
  ...
  var getPrototypeOf = function (obj) {
    if (Object.getPrototypeOf) {
      ...
      return obj.__proto__ // eslint-disable-line
    }
  }
  ...
  var warn = function (message) {
    console.warn('HTTPClient.js warns: ' + message) // eslint-disable-line
  }
